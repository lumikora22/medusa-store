...
export function HistoryScreen() {
  ...
  return <View style={styles.root}><Searchbar accessibilityLabel="Buscar historial" value={search} onChangeText={setSearch} placeholder="Buscar en historial" maxFontSizeMultiplier={1.4} style={styles.search} /><View style={styles.filterPanel}><View style={styles.fieldRow}>
